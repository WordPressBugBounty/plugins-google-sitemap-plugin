...
* Connect your Google Webmaster Tools account to:
	...
	* Delete website
	* Get website info
* Add Sitemap to Google News Sitemap
* Split Sitemap Items
...
= V3.3.6 - 14.05.2026
* NEW : Added Lastmod date source.
* Update : We updated all functionality for wordpress 7.0.
* Update : BWS Panel section was updated.

= V3.3.5 - 27.05.2025
* NEW : Added compatibility with Google News Sitemap.
* Update : We updated all functionality for wordpress 6.8.2.
* Update : BWS Panel section was updated.
